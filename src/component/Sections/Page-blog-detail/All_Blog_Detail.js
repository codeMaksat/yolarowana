...
const All_Blog_Detail = ({ side_bar_data, initialValues }) => {
  return (
    <section className="">
      {initialValues &&
          ...
          return (
            <div className="container" key={index}>
              ...
              <div className="flex flex-col lg:flex-row lg:-mx-5">
                {/* Blog content */}
                <div className="w-full lg:pr-10 lg:px-5 order-1">
                    ...
                    <div className="pt-4">
                      ...
                      {data.description &&
                        data.description.map((description_data, index) => {
                          return (
                            <p key={index}>{description_data.label}</p>
                          );
                        })}
                ...
                {/* Sidebar */}
                <div className="w-full lg:max-w-[340px] shrink-0 lg:px-5 order-2 mt-8 lg:mt-0">
