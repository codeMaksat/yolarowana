...
import guideData from "../../public/json/data/blog_best_places_to_visit_turkmenistan.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/best-places-to-visit-turkmenistan";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_best_places_to_visit_turkmenistan_meta || {};
...
const articleDescription =
  ...
  "Best Places to Visit in Turkmenistan by Belet Travel.";
...
export default function BestPlacesToVisitTurkmenistan() {
