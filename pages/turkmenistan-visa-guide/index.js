...
import guideData from "../../public/json/data/blog_turkmenistan_visa_guide.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/turkmenistan-visa-guide";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta =
  siteMetaData.blog_turkmenistan_visa_guide_meta || {};
...
const articleTitle =
  ...
  articleMeta.title ||
  "Turkmenistan Visa Guide";

const articleDescription =
  articleMeta.description ||
  firstGuide?.description ||
  "Practical information about applying for a Turkmenistan visa.";
...
export default function TurkmenistanVisaGuide() {
