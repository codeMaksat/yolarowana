...
export default function Destination() {
  const { data: hero_tour_detail_data } = useFetchData(
    "json/data/hero_tour_tajikistan_mountain_highlights.json"
  );

  const { data: tour_detail_product_data } = useFetchData(
    "json/data/tour_tajikistan_mountain_highlights_product.json"
  );
  ...
  return (
    <>
      ...
      <Head_Meta meta_data={seo_data.tour_tajikistan_mountain_highlights_meta} comman_meta={seo_data} />
