...
import guideData from "../../public/json/data/blog_darvaza_gas_crater_guide.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/darvaza-gas-crater-guide";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_darvaza_gas_crater_guide_meta || {};
...
const articleTitle =
  ...
  articleMeta.title ||
  "Darvaza Gas Crater Guide";

const articleDescription =
  articleMeta.description ||
  firstGuide?.description ||
  "Darvaza Gas Crater Guide by Belet Travel.";
...
export default function DarvazaGasCraterGuide() {
