...
import guideData from "../../public/json/data/blog_how_to_plan_five_stans_tour.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/how-to-plan-five-stans-tour";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_how_to_plan_five_stans_tour_meta || {};
...
const articleTitle =
  ...
  articleMeta.title ||
  "How to Plan a Five Stans Tour";

const articleDescription =
  articleMeta.description ||
  firstGuide?.description ||
  "How to Plan a Five Stans Tour by Belet Travel.";
