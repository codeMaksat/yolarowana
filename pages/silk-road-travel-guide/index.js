...
import guideData from "../../public/json/data/blog_silk_road_travel_guide.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/silk-road-travel-guide";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_silk_road_travel_guide_meta || {};
...
const articleDescription =
  ...
  "Silk Road Travel Guide by Belet Travel.";
