...
import guideData from "../../public/json/data/blog_kazakhstan_travel_guide.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/kazakhstan-travel-guide";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_kazakhstan_travel_guide_meta || {};
...
const articleDescription =
  ...
  "Kazakhstan Travel Guide by Belet Travel.";
...
export default function KazakhstanTravelGuide() {
