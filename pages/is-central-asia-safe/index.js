...
import guideData from "../../public/json/data/blog_is_central_asia_safe.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/is-central-asia-safe";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_is_central_asia_safe_meta || {};
...
const articleDescription =
  ...
  "Is Central Asia Safe? by Belet Travel.";
...
export default function IsCentralAsiaSafe() {
