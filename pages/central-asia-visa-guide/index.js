...
import guideData from "../../public/json/data/blog_central_asia_visa_guide.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/central-asia-visa-guide";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_central_asia_visa_guide_meta || {};
...
const articleDescription =
  ...
  "Central Asia Visa Guide by Belet Travel.";
...
export default function CentralAsiaVisaGuide() {
