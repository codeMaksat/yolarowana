...
import guideData from "../../public/json/data/blog_uzbekistan_silk_road_guide.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/uzbekistan-silk-road-guide";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_uzbekistan_silk_road_guide_meta || {};
...
const articleTitle =
  ...
  articleMeta.title ||
  "Uzbekistan Silk Road Guide";

const articleDescription =
  articleMeta.description ||
  firstGuide?.description ||
  "Uzbekistan Silk Road Guide by Belet Travel.";
...
export default function UzbekistanSilkRoadGuide() {
