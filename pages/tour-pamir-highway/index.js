...
export default function Destination() {
  const { data: hero_tour_detail_data } = useFetchData(
    "json/data/hero_tour_pamir_highway.json"
  );

  const { data: tour_detail_product_data } = useFetchData(
    "json/data/tour_pamir_highway_product.json"
  );
  ...
  return (
    <>
      ...
      <Head_Meta meta_data={seo_data.tour_pamir_highway_meta} comman_meta={seo_data} />
