...
import guideData from "../../public/json/data/blog_tajikistan_travel_guide.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/tajikistan-travel-guide";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_tajikistan_travel_guide_meta || {};
...
const articleDescription =
  ...
  "Tajikistan Travel Guide by Belet Travel.";
...
export default function TajikistanTravelGuide() {
