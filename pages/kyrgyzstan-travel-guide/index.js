...
import guideData from "../../public/json/data/blog_kyrgyzstan_travel_guide.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/kyrgyzstan-travel-guide";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_kyrgyzstan_travel_guide_meta || {};
...
const articleDescription =
  ...
  "Kyrgyzstan Travel Guide by Belet Travel.";
...
export default function KyrgyzstanTravelGuide() {
