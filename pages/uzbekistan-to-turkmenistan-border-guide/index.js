...
import guideData from "../../public/json/data/blog_uzbekistan_to_turkmenistan_border_guide.json";

const siteUrl = String(
  siteMetaData.http_url || "https://belettravel.com"
).replace(/\/$/, "");

const articlePath = "/uzbekistan-to-turkmenistan-border-guide";
const articleUrl = `${siteUrl}${articlePath}`;
const articleMeta = siteMetaData.blog_uzbekistan_to_turkmenistan_border_guide_meta || {};
...
const articleTitle =
  ...
  articleMeta.title ||
  "Uzbekistan to Turkmenistan Border Guide";

const articleDescription =
  articleMeta.description ||
  firstGuide?.description ||
  "Uzbekistan to Turkmenistan Border Guide by Belet Travel.";
...
export default function UzbekistanToTurkmenistanBorderGuide() {
